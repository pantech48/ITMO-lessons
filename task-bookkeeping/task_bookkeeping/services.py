"""
Модуль содержит функции, которые предоставляют внешние сервисы(ресуры).
"""
...
from task_bookkeeping import resources
from task_bookkeeping.helpers import user_config_dir, user_data_dir
...
def make_default_config():
    ...
    with importlib.resources.path(resources, 'config.ini') as global_config:
        ...
        from_env = os.environ.get('TASK_BOOKKEEPING_CONFIG', '')
